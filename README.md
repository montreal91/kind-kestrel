...
You can always suggest a merge request and report an issue.

## License

All implementations are licensed under the BSD-3-clause license.
See [LICENSE](https://github.com/montreal91/kind-kestrel/blob/dev/LICENSE) for details.

If you are doing something interesting based on my work, please let me know.
